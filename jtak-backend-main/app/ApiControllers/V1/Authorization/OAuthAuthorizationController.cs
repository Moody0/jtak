...
{
    [ApiVersion("1")]
    public class OAuthAuthorizationController : Controller
    {
        ...
        public async Task<IActionResult> Authorize()
        {
            ...
            if (result is null || !result.Succeeded)
            {
                ...
                {
                    return Forbid("LoginRequired", Errors.LoginRequired, "The user is not logged in.");
                }
            ...
            switch (await _applicationManager.GetConsentTypeAsync(application))
            {
                ...
                case ConsentTypes.External when !authorizations.Any():
                    return Forbid("ConsentRequired", Errors.ConsentRequired, "The logged in user is not allowed to access this client application.");
                ...
                case ConsentTypes.Systematic when request.HasPrompt(Prompts.None):
                    return Forbid("ConsentRequired", Errors.ConsentRequired, "Interactive user consent is required.");
