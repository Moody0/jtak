namespace App.Areas.Admin.Controllers
{
    ...
    //    public async Task<IActionResult> Create(City vm)
    //    {
    ...
    //
    //        var model = Mapper.Map<City>(target);
    //        InitViewBags(model);
    //        return View(model);
    //    }
    //
    //    [HttpPost]
    //    [ValidateAntiForgeryToken]
    //    public async Task<IActionResult> Edit(int id, City vm)
    //    {
    ...
    //    #endregion
    //
    //    private void InitViewBags(City vm = null)
    //    {
    //
    //    }
    //
    ...
    //            {
    //                results = (await _service.Queryable()
    //                                        .Where(x => (int)x.Country == id).ToArrayAsync())
