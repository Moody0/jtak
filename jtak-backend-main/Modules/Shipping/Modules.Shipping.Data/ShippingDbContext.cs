...
namespace App.Shipping.Data
{
    public class ShippingDbContext : DbContext
    {
        ...
        public ShippingDbContext(DbContextOptions<ShippingDbContext> options, IHttpContextAccessor contextAccessor)
            : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            {
                entity.SetTableName("Shipping_" + entity.GetTableName());
            }
