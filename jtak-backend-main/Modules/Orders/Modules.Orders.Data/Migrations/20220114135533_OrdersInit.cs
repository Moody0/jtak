        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentDescription = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders_Settings", x => x.Key);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SinglePrice = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    SingleDiscount = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders_OrderDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Orders_OrderDetails_Orders_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_OrderDetails_OrderId",
