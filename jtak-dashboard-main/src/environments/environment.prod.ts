...
export const environment = {
  production: true,
  appVersion: 'v1.0.0',
  USERDATA_KEY: 'tr-gate',
  copyRightUrl: 'https://sol-gr.com',
  baseUrl: 'https://api.jtak.app',
  apiUrl: 'https://api.jtak.app/api/v1',
};
...
//   appHTMLIntegration: 'https://preview.sol-gr.com/metronic8/demo1/documentation/base/helpers/flex-layouts.html',
//   appPreviewUrl: 'https://preview.sol-gr.com/metronic8/angular/demo1/',
//   appPreviewAngularUrl: 'https://preview.sol-gr.com/metronic8/angular/demo1',
//   appPreviewDocsUrl: 'https://preview.sol-gr.com/metronic8/angular/docs',
//   appPreviewChangelogUrl: 'https://preview.sol-gr.com/metronic8/angular/docs/changelog',
//   appDemos: {
//     'demo1': {
//       'title': 'Demo 1',
