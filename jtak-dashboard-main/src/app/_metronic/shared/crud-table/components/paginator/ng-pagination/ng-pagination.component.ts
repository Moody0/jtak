...
export class NgPagination implements OnChanges {
  ...
  @ContentChild(NgPaginationEllipsis, { static: false })
  tplEllipsis: NgPaginationEllipsis;
  @ContentChild(NgPaginationFirst, { static: false })
  tplFirst: NgPaginationFirst;
  ...
  @ContentChild(NgPaginationNumber, { static: false })
  tplNumber: NgPaginationNumber;
  @ContentChild(NgPaginationPrevious, { static: false })
  tplPrevious: NgPaginationPrevious;
