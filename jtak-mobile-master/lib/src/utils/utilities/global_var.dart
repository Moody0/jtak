...
class GlobalVar {
  ...
  static String currencyForamt(num amount, {String currencySymbol = '', int decimalCount = 2}) {
    final formatCurrency =
        NumberFormat.simpleCurrency(decimalDigits: decimalCount, locale: locator<AppStateManager>().appLanguage, name: currencySymbol);
    return formatCurrency.format(amount);
  }

  static String? dateForamt(dynamic date, [String foramt = kDateFormat]) {
    DateTime? temp;
    if (date is String) {
