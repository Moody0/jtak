...
@Deprecated('Do not use glowing neon shadows')
const kPrimaryOrangeGlow = Colors.transparent;
...
const kGreen = Color(0xFF10B981);           // Success, Open store
const kGreenLight = Color(0xFFECFDF5);      // Open store pill background
const kRed = Color(0xFFEF4444);             // Error, Closed store, Discount
const kRedLight = Color(0xFFFEF2F2);        // Closed store pill background
const kAmber = Color(0xFFF59E0B);           // Warning, Busy store, Ratings
const kAmberLight = Color(0xFFFFFBEB);      // Busy / Star badge background
