...
/// ---------------------------------------------------------------------------
/// Universal Search Magnifying Glass Icon facing the standard flipped direction
/// ---------------------------------------------------------------------------
class JtakSearchIcon extends StatelessWidget {
  final double size;
  final Color color;
...
class HeaderCircleButton extends StatelessWidget {
  ...
  /// Standard Search Button facing opposite direction
  factory HeaderCircleButton.search({
    Key? key,
    required VoidCallback onTap,
    double size = 38,
    Color backgroundColor = Colors.white,
