...
class Localeapp {
  ...
  String get theAddress => _data["theAddress"]!;
  ...
  String get orderList => _data["orderList"]!;
  String get home => _data["home"]!;
  String get work => _data["work"]!;
  String get other => _data["other"]!;
  String get searchAddress => _data["searchAddress"]!;
  String get useThisLocation => _data["useThisLocation"]!;
  String get rate => _data["rate"]!;
  String get mostSearched => _data["mostSearched"]!;
  String get newMershmentAccept => _data["newMershmentAccept"]!;
  String get addedToCart => _data["addedToCart"]!;
  String get deliveryAddress => _data["deliveryAddress"]!;
  String get addressDetails => _data["addressDetails"]!;
  String get addressDetailsHint => _data["addressDetailsHint"]!;
  String get startShopping => _data["startShopping"]!;
  String get addressHasBeenChanged => _data["addressHasBeenChanged"]!;
  String get privecyAndUsage => _data["privecyAndUsage"]!;
  String get myAddress => _data["myAddress"]!;
  String get cancelOrder => _data["cancelOrder"]!;
  String get orderDetailsStatusDeliveryCanceled => _data["orderDetailsStatusDeliveryCanceled"]!;
  String get orderDetailsStatusShipping2 => _data["orderDetailsStatusShipping2"]!;
  String get orderConfirm => _data["orderConfirm"]!;
  String get thePayment => _data["thePayment"]!;
}
...
class Localemain {
  ...
  String get pleaseChooseCountry => _data["pleaseChooseCountry"]!;
  String get verifyPhoneNumber => _data["verifyPhoneNumber"]!;
  String get theSum => _data["theSum"]!;
  String get continueWord => _data["continueWord"]!;
...
class Localemsg {
  ...
  String get cartIsEmpty => _data["cartIsEmpty"]!;
  String get smsCodeSend => _data["smsCodeSend"]!;
  String get pleaseAddAddress => _data["pleaseAddAddress"]!;
  String get errorloadingData => _data["errorloadingData"]!;
  String get pleaseChooseLocation => _data["pleaseChooseLocation"]!;
  ...
  String get loginToShowOrders => _data["loginToShowOrders"]!;
  String get addedToCartSuccessfully => _data["addedToCartSuccessfully"]!;
  String get chooseLocationFirst => _data["chooseLocationFirst"]!;
  String get orderSubmittedSuccessfully => _data["orderSubmittedSuccessfully"]!;
  String get addressDeleteSuccessfully => _data["addressDeleteSuccessfully"]!;
  String get ordersEmpty => _data["ordersEmpty"]!;
  String get addAddressWarning => _data["addAddressWarning"]!;
  String get loginToAddMultipleAddress => _data["loginToAddMultipleAddress"]!;
  String get addressSavedSuccessfully => _data["addressSavedSuccessfully"]!;
  String get orderCancelConfirmation => _data["orderCancelConfirmation"]!;
}
